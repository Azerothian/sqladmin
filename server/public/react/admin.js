...
var BackboneMixin, DatabaseList, React, backbone, database, div, li, ul, _, _ref;
...
DatabaseList = React.createClass({
  ...
  render: function() {
    var items;
    items = this.props.databases.map(function(db) {
      return li({}, db.name);
    });
    return ul({}, items);
  }
